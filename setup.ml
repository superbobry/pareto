...
(* OASIS_START *)
(* DO NOT EDIT (digest: abc0ea5eb401ed9edf36ce55bc9ee957) *)
(*
...
(* # 21 "/Users/superbobry/.opam/system/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("gsl",
                               Some (OASISVersion.VGreaterEqual "1.11.0"))
                        ];
                      bs_build_tools =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "û<SÖ\023\157Q­}G2\151´ðÛ+";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;

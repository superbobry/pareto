...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8ae1d70b8a9cb9e463bd8f45a64ae233) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "OCaml statistics library";
          description = None;
          categories = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("gsl", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["math_stubs.c"];
                      bs_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "UÑ\139I©q¸\030âiIsp2?è";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;

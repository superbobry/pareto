...
(* OASIS_START *)
(* DO NOT EDIT (digest: e3dcb6ad041ecf08ce248f71676f4684) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/superbobry/pareto";
            ...
            [
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("gsl",
                               Some (OASISVersion.VGreaterEqual "1.13.0"))
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamldoc"];
                      bs_c_sources = ["mlgsl_extra.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "pareto";
                           FindlibPackage
                             ("core_bench",
                               Some (OASISVersion.VEqual "109.32.00"));
                   ...
                   {exec_custom = false; exec_main_is = "bench_histogram.ml"; 
                   });
               Executable
                 ({
                     cs_name = "bench_kde";
                   ...
                   {exec_custom = false; exec_main_is = "bench_kde.ml"; });
               Executable
                 ({
                     cs_name = "bench_quantile";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "bench_quantile.ml"; 
                   });
               Executable
                 ({
                     cs_name = "test_runner";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "base_ex.ml"; });
               Executable
                 ({
                     cs_name = "distributions_ex";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "distributions_ex.ml";
                      });
               Executable
                 ({
                     cs_name = "tests_ex";
                   ...
                   {exec_custom = false; exec_main_is = "tests_ex.ml"; });
               Executable
                 ({
                     cs_name = "sample_ex";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "sample_ex.ml"; });
               Executable
                 ({
                     cs_name = "resampling_ex";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "resampling_ex.ml"; });
               Doc
                 ({
                     cs_name = "API";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for Pareto";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      ...
                      src_repo_browser =
                        Some "https://github.com/superbobry/pareto";
                      src_repo_module = None;
                      src_repo_branch = None;
                      src_repo_tag = Some "$(pkg_version)";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\007ª¹½åÉï]\154\150\"í\027\024\004¿";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;

...
(* OASIS_START *)
(* DO NOT EDIT (digest: 56d80ffa2e53895ce13d6495f4939782) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Distributions"; "Resampling"; "Sample"; "Tests"];
                      lib_pack = true;
                      lib_internal_modules = ["Internal"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "statistics";
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for Statistics";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "У\024<Х\024\027\014qляв\000§\022~o";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;

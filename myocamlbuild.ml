(* OASIS_START *)
(* DO NOT EDIT (digest: b428cbc26783ac9529850981397016f0) *)
...
let package_default =
  {
     ...
     flags =
       [
          ...
          (["oasis_executable_base_ex_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_executable_base_ex_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_executable_base_ex_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_executable_base_ex_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_executable_base_ex_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_executable_distributions_ex_byte"; "ocaml"; "link"; "byte"
           ],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          ([
              "oasis_executable_distributions_ex_native";
              "ocaml";
              "link";
              "native"
           ],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          ([
              "oasis_executable_distributions_ex_byte";
              "ocaml";
              "ocamldep";
              "byte"
           ],
          ...
          (["oasis_executable_tests_ex_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_executable_sample_ex_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_executable_sample_ex_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_executable_sample_ex_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          ([
              "oasis_executable_sample_ex_native";
              "ocaml";
              "ocamldep";
              "native"
           ],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_executable_sample_ex_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_executable_sample_ex_native"; "ocaml"; "compile"; "native"
           ],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_executable_resampling_ex_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          ([
              "oasis_executable_resampling_ex_native";
              "ocaml";
              "link";
              "native"
           ],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          ([
              "oasis_executable_resampling_ex_byte";
              "ocaml";
              "ocamldep";
              "byte"
           ],
          ...
          ([
            ...
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_executable_resampling_ex_byte"; "ocaml"; "compile"; "byte"
           ],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          ([
              "oasis_executable_resampling_ex_native";
     ...
     includes =
       [("lib_test", ["lib"]); ("examples", ["lib"]); ("benchmarks", ["lib"])
       ];
     }
  ;;
